...
@include('frontend.layout.inc.breadcumb', ['pagename' => 'Product detail'])
...
<div class="single-product-area ptb-100">
            ...
            <div class="col-lg-6">
                <div class="product-single-img">
                    <div class="product-active owl-carousel">
                        ...
                        <div class="item">
                            <img src="{{ asset('uploads/product_photo') }}/{{ $image->product_multiple_image }}" alt="">
                        </div>
                        @endforeach
            ...
            <div class="col-lg-6">
                <div class="product-single-content">
                    ...
                    <div class="rating-wrap fix">
                        ...
                        @endfor
                            <li>({{ $product->product_rating }} Customar Review)</li>
                        </ul>
                    </div>
 ...
 <div class="featured-product-area">
    <div class="container">
        ...
        <div class="row">
            @foreach ($releted_product as $reproduct)

            <div class="col-lg-3 col-sm-6 col-12">
                <div class="featured-product-wrap">
                    <div class="featured-product-img">
                        <img src="{{ asset('uploads/product_photo') }}/{{ $reproduct->product_image }}" alt="">
                    </div>
