                    ...
                    <tbody>
                        @foreach ($testimonials as $testimonial)
                            <tr>
                                ...
                                <td><img src="{{ asset('uploads/testimonial') }}/{{ $testimonial->client_image }}"
                                        class="img-fluid rounded-circle h-50 w-50" alt=""></td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('testimonial.edit', $testimonial->client_name_slug) }}"><i
